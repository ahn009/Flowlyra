...
INTEGRATION_CATALOG: list[dict] = [
    {"provider": "shopify", "name": "Shopify", "category": "ecommerce", "install_type": "oauth2", "priority": "P0", "capabilities": ["orders.sync", "customers.sync", "webhooks"], "authorize_url": "https://{shop}.myshopify.com/admin/oauth/authorize", "token_url": "https://{shop}.myshopify.com/admin/oauth/access_token"},
    ...
    {"provider": "slack", "name": "Slack", "category": "collaboration", "install_type": "oauth2", "priority": "P0", "capabilities": ["notifications", "actions"], "authorize_url": "https://slack.com/oauth/v2/authorize", "token_url": "https://slack.com/api/oauth.v2.access"},
    ...
    {"provider": "salesforce", "name": "Salesforce", "category": "crm", "install_type": "oauth2", "priority": "P0", "capabilities": ["contacts.sync", "leads.sync"], "authorize_url": "https://login.salesforce.com/services/oauth2/authorize", "token_url": "https://login.salesforce.com/services/oauth2/token"},
    {"provider": "hubspot", "name": "HubSpot", "category": "crm", "install_type": "oauth2", "priority": "P0", "capabilities": ["contacts.sync", "deals.sync"], "authorize_url": "https://app.hubspot.com/oauth/authorize", "token_url": "https://api.hubapi.com/oauth/v1/token"},
    ...
    {"provider": "zendesk", "name": "Zendesk", "category": "support", "install_type": "oauth2", "priority": "P1", "capabilities": ["tickets.sync"], "authorize_url": "https://{subdomain}.zendesk.com/oauth/authorizations/new", "token_url": "https://{subdomain}.zendesk.com/oauth/tokens"},
    {"provider": "jira", "name": "Jira", "category": "support", "install_type": "oauth2", "priority": "P1", "capabilities": ["issues.create"], "authorize_url": "https://auth.atlassian.com/authorize", "token_url": "https://auth.atlassian.com/oauth/token"},
    {"provider": "github_issues", "name": "GitHub Issues", "category": "support", "install_type": "oauth2", "priority": "P2", "capabilities": ["issues.create"], "authorize_url": "https://github.com/login/oauth/authorize", "token_url": "https://github.com/login/oauth/access_token"},
